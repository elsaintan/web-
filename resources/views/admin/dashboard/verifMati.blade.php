                ...
                @csrf        
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <img src="{{ asset('/storage/'.$data->ktp) }}" class="img-rounded" width="600px" height="300px">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputState">KK</label>
                            <img src="{{ asset('/storage/'.$data->kk) }}" class="img-rounded" width="600px" height="300px">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <img src="{{ asset('/storage/'.$data->ktp_saksi1) }}" class="img-rounded" width="600px" height="300px">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="inputState">Nama Lengkap</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <img src="{{ asset('/storage/'.$data->ktp_saksi2) }}" class="img-rounded" width="600px" height="300px">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="inputState">Nama Lengkap</label>
