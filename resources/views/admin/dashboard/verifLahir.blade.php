            ...
            <form class="mt-3 mb-2" action="{{ route('send.verifikasi') }}" method="POST" enctype="multipart/form-data">
                @csrf   
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="inputState">Kartu Keluarga</label>
                            <img src="{{ asset('/storage/'.$data->foto_kk) }}" class="img-rounded" width="500px" height="200px">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="inputState">KTP Ibu</label>
                            <img src="{{ asset('/storage/'.$data->ktp_ibu) }}" class="img-rounded" width="600px" height="300px">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputState">Surat Nikah</label>
                            <img src="{{ asset('/storage/'.$data->surat_nikah) }}" class="img-rounded" width="600px" height="300px">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="inputState">KTP Ayah</label>
                            <img src="{{ asset('/storage/'.$data->ktp_ayah) }}" class="img-rounded" width="600px" height="300px">
                        </div>
                    </div>     
                    <hr/>
                    ...
                    <div class="row">
                        <div class="col col-md-6">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="inputState">KTP Saksi 1</label>
                                    <img src="{{ asset('/storage/'.$data->ktp_saksi1) }}" class="img-rounded" width="500px" height="200px">
                                </div> 
                                <div class="form-group col-md-12">
                                    <label for="inputState">Nama Lengkap</label>
                        ...
                        <div class="col col-md-6">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="inputState">KTP Saksi 2</label>
                                    <img src="{{ asset('/storage/'.$data->ktp_saksi2) }}" class="img-rounded" width="500px" height="200px">
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="inputState">Nama Lengkap</label>
