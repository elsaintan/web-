...
<!-- 
        ...
        <table align="center" style=" margin-top:20px">
            <tr align="center">
                <td>
                        <b><u><font size="2">SURAT KETERANGAN TIDAK MAMPU</font></u></b> 
                </td>
            </tr>
    ...
    <table style="margin-top: 10px;margin-bottom:10px">
        <tr style=""> 
            <td>Saya, yang bertanda tangan di bawah ini Pemerintah Kalurahan Sinduharrjo, Kapanewon Ngaglik, Kabupaten Sleman, menerangkan bahwa:</td> 
        </tr>
    </table>
    <table>
        <tr>
    ...
    <table style="margin-top:10px;margin-bottom:10px">
        <tr>
            <td style=""><b><u> Orang tersebut di atas adalah benar-benar TIDAK MAMPU, dan tidak masuk dalam SK Bupati Sleman tahun 2021 sebagai Keluarga Miskin maupun Keluarga Rentan Miskin.</u><b></td>
        </tr>
    </table>
    <table style="margin-top:10px;margin-bottom:10px">
        <tr>
            <td style=""><b> Yang menjadi tanggungan orang terebut di atas :<b></td>
        </tr>
    </table>
    <table>
        <tr>
    ...
    <table style="margin-top:30px">
        <tr>
            <td>Demikian Surat Keterangan Tidak Mampu ini kepada instansi terkait mohon dapat memberikan fasilitas secukupnya.</td>      
        </tr>
    </table>
    ...
    <table align="right" border="" style=" margin-top:30px;padding-top:0px; ">
        <tr>
         ...
         <tr style="">
            <td colspan="2"> a.n.</td>
            <td align="right">Lurah Sinduharjo,</td>
        </tr>
        <tr style="">
            <td>Carik</td>
        </tr>
