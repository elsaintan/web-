        ...
        <div class="col-md-12 card shadow mb-4">
            <form class="mt-3 mb-2" action="{{ route('warga.pengajuan.store') }}" method="POST"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="inputState">Surat Pengantar RT/RT</label>
                        <div class="input-group">
                            <input class="form-control" name="super" type="file" id="actual-btn" />
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputState">Surat Keterangan Kematian (RS)</label>
                        <div class="input-group">
                            <input class="form-control" name="suket" type="file" id="actual-btn" />
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="inputState">KTP yang Meninggal</label>
                        <div class="input-group">
                            <input class="form-control" name="ktpmeninggal" type="file" id="actual-btn" />
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputState">KK yang meninggal</label>
                        <div class="input-group">
